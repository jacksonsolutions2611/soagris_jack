...
class import_product_var_wizard(models.TransientModel):
    ...
    is_create_m2m_record = fields.Boolean(string = "Create a New Record for Dynamic M2M Field (if not exist)?")

    is_create_categ_id_record = fields.Boolean(string = "Create a New Record for Product Category Field (if not exist)?")
