...
class ImportProductTemplateWizard(models.TransientModel):
    ...
    def import_product_tmpl_apply(self):
        ''' ................. perform Product Template Import Using CSV and EXCEL ............ '''
                            ...
                            if row[0].strip() not in (None, ""):
                                ...
                                if row[9].strip() in (None, ""):
                                    ...
                                    if search_uom:
                                        ...
                                        skipped_line_no[str(
                                            counter)] = " - Units of Measure - Units not found. "
                                        counter = counter + 1
                                        continue
                                else:
                                    search_uom = self.env['uom.uom'].search(
                                    ...
                                    if search_uom:
                                        ...
                                        skipped_line_no[str(
                                            counter)] = " - Units of Measure not found. "
                                        counter = counter + 1
                                        continue
                                ...
                                if row[10].strip() in (None, ""):
                                    ...
                                    if search_uom_po:
                                        ...
                                        skipped_line_no[str(
                                            counter)] = " - Purchase Units of Measure - Units not found. "
                                        counter = counter + 1
                                        continue
                                else:
                                    search_uom_po = self.env['uom.uom'].search(
                                    ...
                                    if search_uom_po:
                                        ...
                                        skipped_line_no[str(
                                            counter)] = " - Purchase Units of Measure not found. "
                                        counter = counter + 1
                                        continue
                                ...
                                if row[18].strip() not in (None, ""):                                    
                                    ...
                                    if "http://" in image_path or "https://" in image_path:
                                        try:
                                            ...
                                            if r and r.content:
                                                image_base64 = base64.encodebytes(r.content)                                                
                                                vals.update(
