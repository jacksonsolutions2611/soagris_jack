...
# Part of Softhealer Technologies.
{
 ...
 Import Partner From Csv, Import Product From Excel,  Import Sale Order From Csv ,Import Purchase Order From Excel Module,Import Account From Csv, Import Invoice From Excel,Import Inventory From Xls, Import Stock From Xlsx, Import Bill Of Material From CSV, Import CRM From Csv, Import Lead From XLS,Import Project From XLSX, Import Task From Excel, Import Reordering Rules From XLS Odoo. """,
    ...
    "data": [
        ...
        "sh_import_reordering_rules/wizard/import_reordering_rule_wizard_views.xml",
        ...
        "sh_import_bom/wizard/import_bom_wizard_views.xml",
        "sh_import_bom/views/mrp_views.xml",
        ...
        "sh_import_int_transfer_adv/security/import_int_transfer_adv_security.xml",
        "sh_import_int_transfer_adv/security/ir.model.access.csv",
        "sh_import_int_transfer_adv/wizard/import_int_transfer_wizard_views.xml",
        ...
        "sh_import_product_img/wizard/import_product_img_wizard_views.xml",
        "sh_import_product_img/views/sale_views.xml",
        ...
        "sh_import_emp_img/views/hr_views.xml",

        "sh_import_emp_timesheet/security/import_emp_timesheet_security.xml",
        "sh_import_emp_timesheet/security/ir.model.access.csv",
        "sh_import_emp_timesheet/wizard/import_emp_timesheet_wizard_views.xml",
        "sh_import_emp_timesheet/views/timesheet_views.xml",

        "sh_import_partner_img/security/import_partner_img.xml",
        "sh_import_partner_img/security/ir.model.access.csv",
        "sh_import_partner_img/wizard/import_partner_img_wizard_views.xml",
        "sh_import_partner_img/views/sale_views.xml",
        ...
        "sh_import_img_zip/wizard/import_img_zip_wizard_views.xml",
        "sh_import_img_zip/views/sale_views.xml",
        ...
        "sh_import_img_zip_shop/security/sh_import_img_zip_shop_security.xml",
        ...
        'sh_import_chart_of_account/views/account_account_menus.xml',

        "sh_import_product_var_shop/security/ir.model.access.csv",
        "sh_import_product_var_shop/security/import_product_var_shop_security.xml",
        "sh_import_product_var_shop/wizard/import_product_var_shop_wizard_views.xml",
        "sh_import_product_var_shop/views/sale_views.xml",
